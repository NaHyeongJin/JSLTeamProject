...
<%@ page import = "model.dao.*,model.vo.*" %>
      ...
      <div class="container">
         ...
         <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
               ...
               <!-- 관리자 로그인  -->
              <c:if test="${grade=='a' }">
               <li class="nav-item"><a class="nav-link" href="/LogoutServlet.do"> 로그아웃</a></li>
				<li class="nav-item"><a class="nav-link" href="/join/register.jsp">내정보가기</a></li>
               <li class="nav-item"><a class="nav-link" href="/join/register.jsp">회원목록리스트</a></li>
               </c:if>
				<!-- 회원 로그인  -->
